...
const sortOptions = [
  ...
  { name: "Price: High to Low", sort: "id",order: "desc", current: false },
];
const filters = [
  {
    id: "category",
...
export default function ProductList() {
      ...
      <div>
        <div className="bg-white">
          <div>
            ...
            <MobileFilte handleFilter={handleFilter} setMobileFiltersOpen={setMobileFiltersOpen} mobileFiltersOpen={mobileFiltersOpen}></MobileFilte>
 ...
 function MobileFilte  ({setMobileFiltersOpen,mobileFiltersOpen,handleFilter})  {
  return (
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            ...
                            <Link to="product-detail">
                              <div
                                className="group relative p-1 border-solid border-2 border-gray-200"
                              >
