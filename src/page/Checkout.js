...
const Checkout = () => {
  return (
    ...
    <div className="border-b border-gray-900/10 pb-12">
        ...
        <li key={address.email} className="flex justify-between px-3 gap-x-6 py-5 border-solid border-2 border-gray">
          ...
          <input
            ...
            <div className="min-w-0 flex-auto">
              ...
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">{address.pincCode}</p>
            </div>
          </div>
    ...
    <div className="mx-auto max-w-3xl px-0 sm:px-0 lg:px-0">
          <h2 className="text-4xl pt-10 mb-10 text-center font-bold tracking-tight text-gray-900">
          Cart
          </h2>
