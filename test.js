...
brands.map(c => ({value:c, lable:c.split('-').join(' '), checked:false}))
//this is the method that will be filter the product brand values and new set methode use to unique values and  store in the brands and then store the value in the form of array value and lebel form  